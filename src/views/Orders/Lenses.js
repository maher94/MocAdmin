...
class Lenses extends Component {
  ...
  getListOrdersLenses = _ => {
    ...
    fetch('https://mocbackend.cleverapps.io/ordersLentille/listLenses')
  ...
  exportPDF = () => {
    ...
    const data = this.state.data.map(elt=> [elt.Orderno, elt.Orderdate.substring(0, 10),elt.Category,elt.Products,elt.Status,elt.Comment,elt.qte,elt.pss,elt.FirstName,elt.LastName]);
    const headers = [["Orderno", "Orderdate","Category","Products","Status","Comment","Quantity","Sph","FirstName","LastName"]];
