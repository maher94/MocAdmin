...
class OrdersProduitByStatus extends Component {
  constructor(props) {
    super(props);
    this.state = {
      result: [],
  ...
  productByVolume = () => {
    ...
    fetch('http://localhost:4000/ordersProduit/getNborderbyStatus' )
...
export default OrdersProduitByStatus;
