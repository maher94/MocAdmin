    ...
    >
      ...
      data={query =>
        new Promise((resolve, reject) => {
          let url = 'http://localhost:4000/ordersLentille//listSuspendedLensesOrders'
          fetch(url)
...
export default SuspendedLenses;
