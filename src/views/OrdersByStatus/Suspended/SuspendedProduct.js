...
const tableIcons = {
  Paly: forwardRef((props, ref) => <Play {...props} ref={ref} />),
  ...
  return (
    ...
    >
      <Container maxWidth={false}>
        ...
        <MaterialTable
        icons={tableIcons}
      title=" Suspended Product Orders "
      columns={[
      ...
      data={query =>
        new Promise((resolve, reject) => {
          let url = 'https://mocbackend.cleverapps.io/ordersProduit//listSuspendedProductOrders'
          fetch(url)
