    ...
    >
      ...
      data={query =>
        new Promise((resolve, reject) => {
          let url = 'http://localhost:4000/ordersProduit//listPaidProductOrders'
          fetch(url)
        ...
        } ,
         {
          ...
          onClick: (event, rowData) => {
           ...
           setRow(row.push(element.Orderno))
            ...
            OrderAPI.updateStatus(row,"Produit","Closed");handleClickOpen("Closed")}
