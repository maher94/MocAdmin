...
import Suspended from '@material-ui/icons/Pause'
...
const tableIcons = {
  close: forwardRef((props, ref) => <NotInterested {...props} ref={ref} />),
  Suspended: forwardRef((props, ref) => <Suspended {...props} ref={ref} />),
    ...
    >
      ...
      columns={[
        ...
        },
        {
          ...
          field: 'Status',
          editable: 'never',
          lookup:{WaitingValidation:"Waiting Validation",Draft:"Draft",Validated :"Validated" ,InProgress :"In Progress" ,Suspended :"Suspended" ,Created:"Created",Rejected:"Rejected",Paid:"Paid",PartiallyPaid:"Partially Paid"},        
      ...
      data={query =>
        new Promise((resolve, reject) => {
          let url = 'http://localhost:4000/ordersLentille//listValidatedLensesOrders'
          fetch(url)
      ...
      actions={[
        {
          ...
          onClick: (event, rowData) => {
           ...
           setRow(row.push(element.Orderno))
            ...
            OrderAPI.updateStatus(row,"Lentille","InProgress") ;handleClickOpen("In Progress")}
        ...
        } ,
        {
          ...
          onClick: (event, rowData) =>{ 
           ...
           setRow(row.push(element.Orderno))
            ...
            OrderAPI.updateStatus(row,"Lentille","Rejected");handleClickOpen("Rejected")}
...
export default ValidatedLenses;
