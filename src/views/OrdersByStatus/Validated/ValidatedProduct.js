  ...
  return (
    ...
    >
      <Container maxWidth={false}>
        ...
        <MaterialTable
        icons={tableIcons}
      title=" Validated Product Orders "
      columns={[
      ...
      data={query =>
        new Promise((resolve, reject) => {
          let url = 'https://mocbackend.cleverapps.io/ordersProduit//listValidatedProductOrders'
          fetch(url)
      ...
      actions={[
        {
          ...
          onClick:  (event, rowData) =>{
           ...
           setRow(row.push(element.Orderno))
            ...
            OrderAPI.updateStatus(row,"Produit","InProgress") ;handleClickOpen("In Progress")}
