...
const tableIcons = {
  Reply: forwardRef((props, ref) => <Reply {...props} ref={ref} />),
    ...
    >
      ...
      data={query =>
        new Promise((resolve, reject) => {
          let url = 'https://mocbackend.cleverapps.io/ordersLentille//listRejectedLensesOrders'
          fetch(url)
